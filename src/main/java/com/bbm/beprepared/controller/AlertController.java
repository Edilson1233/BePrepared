...
import com.bbm.beprepared.services.AlertService;
...
public class AlertController {
    ...
    public ResponseEntity<String> createAlert(@Valid @RequestBody AlertRequestDto alertRequestDto) {
        return new ResponseEntity<>(
                alertService.createAlert(mapper.mapAlertRequestToModel(alertRequestDto),
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AlertResponseDto> getAlertsById(@PathVariable Long id){
